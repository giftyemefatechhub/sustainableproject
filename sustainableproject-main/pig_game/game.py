...
class Game:
    """A class representing the One Dice Pig game."""

    def __init__(self):
        """Initialize the Game object."""
        self.rules()
        self.number_of_players = int(
            input("Enter number of players (1) or (2): "))
    ...
    def rules(self):
        ...
        print("..............................")
        print("Goal: Players take turns rolling a dice and become the winner when their score reaches 100")
        print(" ")
        print("Gameplay Rules:")
        print("1. Each round, a player repeatedly rolls the dice until either a 1 is rolled or the player decides to hold")
        print("2. If the player rolls a 1, they score no points and their turn ends.")
        print("3. If the player rolls any other number, it is added to their turn total and the player can choose to roll again or hold.")
    ...
    def play(self):
        """Start the game based on the number of players chosen."""
    ...
    def restart(self):
        ...
        if restart == "y":
            print(
                f"{self.player} Restarted game. {self.computer} automatically won the previous hand")
            print(".......................................................")
    ...
    def player_quit(self):
        """Check if a player wants to quit the game and handle accordingly."""
        if self.player1.player_score < 50:
            quit = input(
                f"{self.player1} do you want to quit the game (y/n)? ")
            if quit == "y":
                print(".......................................................")
                print(f"{self.player1} Forfeited. {self.player2} automatically won!")
                self.highscore.won_game(self.player2)
                self.highscore.update_score(self
                                            .player1, self.player1.player_score)
                self.highscore.update_score(
                    self.player2, self.player2.player_score)
                print(" ")
    ...
    def player_vs_computer(self):
        """Start a game between a player and the computer."""
        ...
        if first_to_play <= 5:
            ...
            while self.computer.computer_score < 100 and self.player.player_score < 100:
                ...
                self.player.round()
                self.highscore.update_score(
                    self.player, self.player.player_score)
                print(".......................................................")
